...
public class InventoryMenu extends JFrame implements ActionListener {
    ...
    private JLabel txtWelcome, txtMessage, txtMessage2, BackGroundImage, txtInventory, Logo;
    private JComboBox foodComboBox;
    private JTextField tfquantity;
    private JButton btnPOS, btnReports, btnWasteTracking, btnAdd, btnAdd2, btnReturn;
    ...
    InventoryMenu() {
        ...
        txtInventory = new JLabel("Inventory");
        txtInventory.setBounds(20, 250, 150, 27);
        txtInventory.setBackground(new Color(0, 0, 0, 0));
        txtInventory.setOpaque(false);
        txtInventory.setForeground(Color.white);
        txtInventory.setFont(new Font("impact", Font.PLAIN, 27));
        add(txtInventory);
    ...
    private void RefreshFood() { // this add the food to the table at the same time it refreshes it
