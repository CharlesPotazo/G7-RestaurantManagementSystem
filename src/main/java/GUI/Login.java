...
public class Login extends JFrame implements ActionListener {
    ...
    Login() {
        ...
        //-----------Ito po yung para sa Text namin------------
        ...
        //-----------Ito po yung para sa TextField namin------------
        ...
        //-----------Ito po yung para sa mga Button namin------------
        ...
        //----------ito po yung para sa mga Panels---------
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == signinButton) {
            ...
            if (userService.verifyUser(accountNumber, Password)) {  //This method verifies the user in the business logic. In a way, para na rin po siya abstraction
                new MainMenu(); // Go to Main  Menu Class po
                this.dispose(); //dispose current Frame po
            } else {
                promptText.setText("INVALID");  //If di po existing yung user  
            }
